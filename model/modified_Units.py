...
#=========initial==============================
    ...
    def __init__(self, input_size=4096, sensor_num=12, layer_num=1,
        window_list=[49,256,512,768,1024], stride_list=[24,128,256,384,512], k_list=[24,128,256,384,512], out_dim=7, hidden_channel = 48):

        super(mod_UniTS, self).__init__()
